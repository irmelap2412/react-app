...
export function Leftsidebar({ setActiveComponent, activeComponent }) {
  return (
    <div className="sidebar">
      <div className="sidebar-content">
        ...
        <div className="scroll-area">
          ...
          <div className={`nav-item ${activeComponent === "Friendactivity" ? "active" : ""}`}
          onClick={() => setActiveComponent("Friendactivity")}>
            ...
            <div className={`nav-item ${activeComponent === 'Friends' ? 'active' : ''}`} onClick={() => setActiveComponent('Friends')}>
            ...
            <div className="nav-item" onClick={() => setActiveComponent('Messages')} >
            ...
            <div  className="nav-item" onClick={() => setActiveComponent('Notifications')}>
            ...
            <div className="nav-item" onClick={() => setActiveComponent('Saved')} >
            ...
            <div className="nav-item" onClick={() => setActiveComponent('Settings')} >
